...
class _MapBoxAutoCompleteWidgetState extends State<MapBoxAutoCompleteWidget> {
  ...
  Future<void> _getPlaces(String input) async {
    if (input.length > 0) {
      String url =
          "/geocoding/v5/mapbox.places/$input.json?access_token=${widget.apiKey}&cachebuster=1566806258853&autocomplete=true&language=${widget.language}&limit=${widget.limit}";
      ...
      final uri = Uri.https("api.mapbox.com", url);
